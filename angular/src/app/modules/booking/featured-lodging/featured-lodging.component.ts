...
export class FeaturedLodgingComponent implements OnChanges {
  ...
  public setAvailableCountsByType(): void {
    ...
    for (const thisLodging of this.displayLodgings) {
      ...
      let totalCountByType: Map<string, number>;
      let availableCountByType: Map<string, number>;
      lodgingLotTypes = [];
      totalCountByType = new Map<string, number>();
      availableCountByType = new Map<string, number>();
